...
func TestMapCatalogFiltersImagesIncompatibleWithBootstrap(t *testing.T) {
	catalog := mapCatalog(Catalog{Images: []Image{
		{Slug: "ubuntu-24-04-x64", Name: "24.04 (LTS) x64", Distribution: "Ubuntu", Status: "available", Public: true},
		{Slug: "ubuntu-22-04-x64", Name: "22.04 (LTS) x64", Distribution: "Ubuntu", Status: "available", Public: true},
		{Slug: "debian-12-x64", Name: "Debian 12 x64", Distribution: "Debian", Status: "available", Public: true},
		{Slug: "windows-2025-x64", Name: "Windows Server 2025", Distribution: "Windows", Status: "available", Public: true},
	}}, "")
	if len(catalog.Images) != 1 || catalog.Images[0].Name != "ubuntu-24-04-x64" {
