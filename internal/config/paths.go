...
func NamespaceCredentialsPath(namespace string) string {
	return ServerCredentialsPath(namespace, servername.Default)
}
...
func ProjectCredentialsPath(project string) string {
	return ServerCredentialsPath(project, servername.Default)
}
