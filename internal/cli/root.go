...
func New() *cobra.Command {
	a := &app{stdin: os.Stdin, stdout: os.Stdout, stderr: os.Stderr, jsonOut: true}
	cmd := &cobra.Command{
		Use:           "serverpro",
	...
	cmd.AddCommand(a.namespaceCmd(), a.serverCmd(), a.providerCmd(), a.catalogCmd(), a.ingressCmd(), a.globalDoctorCmd())
	return cmd
}
